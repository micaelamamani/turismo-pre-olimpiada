window.onload = async () => {
   try {
        ...
        const normal = productos.filter(p => p.destacado === "normal");
        const promos = productos.filter(p => p.destacado === "promo");
        const recomendado = productos.filter(p => p.destacado === "recomendado");

        mostrarTarjetas(normal.slice(0, 4), "contenedorNormal");
        mostrarTarjetas(promos.slice(0, 4), "contenedorPromos");
        mostrarTarjetas(recomendado.slice(0, 4), "contenedorRecomendado");
